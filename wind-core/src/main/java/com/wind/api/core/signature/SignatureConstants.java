...
public final class SignatureConstants {
     ...
     * 用于交换签名秘钥
     */
    public static final String ACCESS_ID_HEADER_NAME = "Access-Id";
     ...
     * 非 AK/SK 访问模式需要
     */
    public static final String SECRET_VERSION_HEADER_NAME = "Secret-Version";
     ...
     * 仅在线下联调环境下开启
     */
    public static final String DEBUG_SIGN_CONTENT_HEADER_NAME = "Debug-Sign-Content";

    /**
     * 在签名验证失败时返回服务端的查询参数签名串
     * 仅在线下联调环境下开启
     */
    public static final String DEBUG_SIGN_QUERY_HEADER_NAME = "Debug-Sign-Query";
